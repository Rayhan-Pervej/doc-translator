...
Claude infers domain terminology from it (e.g. financial file → use financial terms).

Option B (future): add a `glossary.json` with approved term mappings (e.g. 売上高 → Revenue).
